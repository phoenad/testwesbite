...
import { Twitter, Trophy } from 'lucide-react';
      ...
      <div className="relative min-h-screen bg-black text-white overflow-hidden">
        ...
        <div className="relative flex min-h-screen flex-col items-center justify-center px-6 z-10">
          <div className="max-w-5xl w-full text-center space-y-8 md:space-y-12">
            ...
            {/* Leaderboard Link - Only show when logged in */}
            {user && (
              <div className="flex justify-center animate-fade-in-up delay-5">
                <Link to="/leaderboard">
                  <Button className="px-6 py-3 bg-gradient-to-r from-yellow-400/20 to-orange-500/20 text-white rounded-full gap-2 border border-yellow-400/30 hover:from-yellow-400/30 hover:to-orange-500/30 transition-all duration-300 border-2 border-yellow-400/30">
